    ...
    <div class="bg-primary">   
        ...
        <div class="relative">
            ...
            <a href="https://twitter.com/luckybooknft" target="_blank" rel="noopener">
                <button type="button" class="bg-twitter text-neutral text-sm rounded-full h-16 w-16 lg:h-20 lg:w-20 flex items-center justify-center absolute -ml-12 lg:-ml-16 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2"> <img class="w-8 lg:w-10" src="~/assets/images/twitterIconWhite.svg" alt="Twitter icon white">
                </button>
            </a>

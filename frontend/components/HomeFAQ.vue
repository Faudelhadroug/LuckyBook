    ...
    <div class="bg-primary text-neutral text-center py-10 lg:py-32"> 
        ...
        <div class="space-y-14">
            <div @click="() => visibleElem == 1? visibleElem = 0 : visibleElem = 1" class="mx-6 md:mx-20 xl:mx-40">
                <p class="mb-4 font-bold inline-block">How much does it cost to mint a LuckyBook?</p><img class="w-5 ml-1 md:ml-2 inline-block" :src="visibleElem == 1 ? '/dropUp.svg' : '/dropDown.svg'" :alt="visibleElem == 1 ? 'dropUp Icon' : 'DropDown Icon'">
                <p :class="visibleElem == 1 ? 'block' : 'hidden'">Each LuckyBook is 88 $HTR. When the mint is open you will be able to specify the quantity of LuckyBook you want and you'll be told the amount to send.</p>
            </div>
            <div @click="() => visibleElem == 2? visibleElem = 0 : visibleElem = 2"  class="mx-6 md:mx-20 xl:mx-40">
                <p class="mb-4 font-bold inline-block">How to buy LuckyBook?</p><img class="w-5 ml-1 md:ml-2 inline-block" :src="visibleElem == 2 ? '/dropUp.svg' : '/dropDown.svg'" :alt="visibleElem == 2 ? 'dropUp Icon' : 'DropDown Icon'">
            ...
            <div @click="() => visibleElem == 3? visibleElem = 0 : visibleElem = 3"  class="mx-6 md:mx-20 xl:mx-40">
                <p class="mb-4 font-bold inline-block">Where to get a Hathor wallet?</p><img class="w-5 ml-1 md:ml-2 inline-block" :src="visibleElem == 3 ? '/dropUp.svg' : '/dropDown.svg'" :alt="visibleElem == 3 ? 'dropUp Icon' : 'DropDown Icon'">
            ...
            <div @click="() => visibleElem == 4? visibleElem = 0 : visibleElem = 4"  class="mx-6 md:mx-20 xl:mx-40">
                <p class="mb-4 font-bold inline-block">How to transfer funds to the Hathor wallet?</p><img class="w-5 ml-1 md:ml-2 inline-block" :src="visibleElem == 4 ? '/dropUp.svg' : '/dropDown.svg'" :alt="visibleElem == 4 ? 'dropUp Icon' : 'DropDown Icon'">
            ...
            <div @click="() => visibleElem == 5? visibleElem = 0 : visibleElem = 5"  class="mx-6 md:mx-20 xl:mx-40">
                <p class="mb-4 font-bold inline-block">How long does it take for the LuckyBook to show up on my Hathor wallet?</p><img class="w-5 ml-1 md:ml-2 inline-block" :src="visibleElem == 5 ? '/dropUp.svg' : '/dropDown.svg'" :alt="visibleElem == 5 ? 'dropUp Icon' : 'DropDown Icon'">
                <p :class="visibleElem == 5 ? 'block' : 'hidden'">Up to a few minutes.</p>
            </div>
